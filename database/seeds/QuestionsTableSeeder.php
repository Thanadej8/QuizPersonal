...
class QuestionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('questions')->insert([
            ...
            'choice1' => 'ฉันมีความสัมพันธ์ที่ดีกับคนอื่นอยู่แล้ว หากไม่มีปัญหาเกิดขึ้นก็ไม่ต้องดำเนินการใดๆ',
            'choice1_type' => 'S',
            'choice2' => 'ยังมีสิ่งที่สามารถดำเนินการเพื่อสร้างความสัมพันธ์ให้ดียิ่งขึ้นได้อีก',
            'choice2_type' => 'N',
			'set' => '1',
        ]);
		...
		DB::table('questions')->insert([
            ...
            'choice1' => 'ดูความรู้ความสามารถเป็นหลัก แล้วค่อยพิจารณาสิ่งอื่น',
            'choice1_type' => 'T',
		...
		DB::table('questions')->insert([
            ...
            'choice1' => 'ถึงแม้จะรู้สึกเจ็บปวด ฉันสามารถที่จะตัดเขาออกไปจากความรู้สึกได้',
            'choice1_type' => 'T',
            'choice2' => 'ฉันมักเสียใจอย่างหนัก คิดซ้ำๆ เกี่ยวกับกับความสัมพันธ์ที่จบลง',
            'choice2_type' => 'F',
			'set' => '2',
        ]);
		...
		DB::table('questions')->insert([
            ...
            'choice1' => 'เน้นการพูดคุยใช้เหตุผล พูดกันตรงๆ ในประเด็นที่มีความสนใจร่วมกัน',
            'choice1_type' => 'T',
		...
		DB::table('questions')->insert([
            ...
            'choice1_type' => 'T',
            'choice2' => 'อบอุ่น เห็นอกเห็นใจ อ่อนไหวต่อความรู้สึก',
            'choice2_type' => 'F',
			'set' => '2',
        ]);
